defmodule Rss2Nostr.Nostr.NIP44 do
  ...
  @type nip44_error :: :json_decode_failed | :operation_failed | String.t()

  @doc """
  Encrypts plaintext to `recipient_pubkey` using the sender's private key.
  """
  @spec encrypt(String.t(), binary(), String.t()) :: {:ok, String.t()} | {:error, nip44_error()}
  ...
  """
  @spec decrypt(String.t(), binary(), String.t()) :: {:ok, String.t()} | {:error, nip44_error()}
  ...
  @spec run_nip44(String.t(), binary(), String.t(), keyword()) ::
          {:ok, String.t()} | {:error, nip44_error()}
